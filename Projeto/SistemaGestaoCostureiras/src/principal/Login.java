...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbxMostrarSenha.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
    ...
    public void LogarUsuario(){
        try {
            ...
            usrDados.setNome_usuario(txtNome.getText());
            usrDados.setSenha_usuario(txtSenha.getText());

            ResultSet rsUsuarioDao = new usuarioDAO().autenticacaoUsuario(usrDados);
            ...
            JOptionPane.showMessageDialog(null, "LoginPrincipal" + e);
        }
    }
